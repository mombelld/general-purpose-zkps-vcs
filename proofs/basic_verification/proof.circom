...
component main {public [exp_name, status_list, status_list_uri_name, status_list_uri_value, status_list_idx_name, iss_pk_x, iss_pk_y, now_timestamp, date_offset_name, date_offset_value]} = Proof(22, 1024);